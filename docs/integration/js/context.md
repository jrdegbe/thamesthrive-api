...
You can respect the browser setting and do not to track the user. If you decide to do this ThamesThrive will not load the
...
If the `respectDoNotTrack` is missing in the settings than ThamesThrive sets default setting and loads tracking script.
